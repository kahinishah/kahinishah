...
```{r}
ggplot(project, aes(x = tnorm, y = PV)) + geom_point() + theme_minimal() + labs(title ="% Overall Acceptability of IPV Against Women vs Rate of Physical IPV", x = "Acceptability of Violence Against Women", y = "Rate of Physical IPV") 
